...
const ChatInterface: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-xl font-semibold">Loading DrishtiGPT...</p>
          <p className="text-gray-500 text-sm mt-2">Preparing your AI experience</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex overflow-hidden">
      ...
      <div className="flex w-full relative z-10">
        ...
        <div className="flex-1 h-full" style={{ display: "flex" }}>
          <ChatArea
            ...
            sessionTitle={currentSession?.title} // Pass session title
            sessionCreatedAt={currentSession?.created_at} // Pass session created date
      ...
      <CreateSessionPrompt isOpen={isPromptOpen} onClose={() => setIsPromptOpen(false)} onCreate={handleNewSession} />
    </div>
  )
}
